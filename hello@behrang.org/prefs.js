	...
	fillPreferencesWindow(window) {
		...
		group.add(
			this._createComboRow(
				"Wraparound mode",
				"wraparound-mode",
				["None", "Next/Previous", "Rows/Columns", "Next/Previous Bordered"],
				settings,
			),
		);
		...
		group.add(
			this._createSwitcherRow(
				"Select workspaces with mouse hover in popup",
		...
		group.add(
			this._createSpinRow(
				"Scale of workspace switcher popup",
				"scale",
				{
					value: 0.5,
					lower: 0.01,
		...
		group.add(
			this._createSwitcherRow(
				"Show workspace grid in overview",
				"show-overview-grid",
				settings,
			),
		);
