...
// Test configuration
const SCHEMA_ID =
	"org.gnome.shell.extensions.org.nutthead.workspace-matrix-settings";
const SCHEMA_PATH =
	"/org/gnome/shell/extensions/org/nutthead/workspace-matrix/";
...
function simulateUITest() {
	...
	try {
		...
		print(
			`📖 Reading current value: ${currentValue} (${ENUM_NAMES[currentValue]})`,
		);
